// ==UserScript==
// @name         Canadasplace Userscript (Autoupdater)
// @namespace    https://github.com/Canadasplace/Userscript
// @version      0.0.2
...
// @updateURL    https://github.com/Canadasplace/Userscript/releases/download/latest/Canadasplace-userscript-autoupdater.user.js
// @downloadURL  https://github.com/Canadasplace/Userscript/releases/download/latest/Canadasplace-userscript-autoupdater.user.js
// @grant        GM.xmlHttpRequest
// @connect      github.com
// @connect      objects.githubusercontent.com
// ==/UserScript==

const SCRIPT_LOCATION = 'https://github.com/Canadasplace/Userscript/releases/download/latest/Canadasplace-userscript.user.js';
const UPDATE_CHECK_INTERVAL = 10 * 60 * 1000;

(function () {
    (typeof unsafeWindow !== 'undefined' ? unsafeWindow : window).Canadasplace_USERSCRIPT_AUTO_UPDATER = {
        version: '0.0.1',
        updateHook: () => {
        }
    };
            ...
            setInterval(() => {
                GM.xmlHttpRequest({
                    ...
                    onload: async (response) => {
                        ...
                        await (typeof unsafeWindow !== 'undefined' ? unsafeWindow : window).Canadasplace_USERSCRIPT_AUTO_UPDATER.updateHook();
